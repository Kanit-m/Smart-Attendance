...
import { School, UserCog, GraduationCap, LogOut } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ currentUser, onLoginAdmin, onLoginTeacher, onLogout, logoUrl }) => {
