  ...
  return (
    <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-lg border border-white/50 flex flex-col md:flex-row overflow-hidden min-h-[80vh]">
        ...
        <div className="flex md:flex-col p-2 md:p-4 gap-1 md:gap-2 min-w-max md:min-w-0 w-full">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all whitespace-nowrap w-auto md:w-full ${
                activeTab === tab.id 
      ...
      <div className="flex-1 p-4 md:p-8 overflow-y-auto bg-white/30">
        {activeTab === 0 && <div className="-m-2 md:m-0"><Dashboard embedded /></div>}
